...
class AdminUuLalulintasController extends \crocodicstudio\crudbooster\controllers\CBController
{
    ...
    public function cbInit()
    {
        ...
        $this->table = "uu_lalulintas";
        # END CONFIGURATION DO NOT REMOVE THIS LINE

        # START COLUMNS DO NOT REMOVE THIS LINE
        $this->col = [];
        $this->col[] = ["label" => "Pasal", "name" => "pasal"];
        ...
        # OLD START FORM
        //$this->form = [];
        //$this->form[] = ["label"=>"Pasal","name"=>"pasal","type"=>"text","required"=>TRUE,"validation"=>"required|min:1|max:255"];
